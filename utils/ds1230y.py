...
class ds1230y(object):
	def __init__(self, programmer):
		...
		self.address_bus = allpro88.bus_parallel_ttl(self.programmer, self.socket, (10, 9, 8, 7, 6, 5, 4, 3, 25, 24, 21, 23, 2, 26, 1))
		...
		self.write_enable_flag = allpro88.flag_ttl_active_low(self.socket, 27)
	...
	write_enable = devices.flag_proxy("write_enable_flag")


with open("dump.dat", "wb") as dump:
	with allpro88.allpro88() as programmer:
		with ds1230y(programmer) as device:
